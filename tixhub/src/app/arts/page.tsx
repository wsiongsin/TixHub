  ...
  const fetchEvents = useCallback(async () => {
    try {
      ...
      if (location === "all") {
        ...
        const allEvents = await Promise.all(
          cities.map(async (city) => {
            const response = await fetch(
              `https://app.ticketmaster.com/discovery/v2/events.json?apikey=${apiKey}&classificationName=Arts&Theatre&segmentName=Arts&Theatre&city=${city}&size=200`
            );
        ...
        const response = await fetch(
          `https://app.ticketmaster.com/discovery/v2/events.json?apikey=${apiKey}&classificationName=Arts&Theatre&segmentName=Arts&Theatre&city=${location}&size=200`
        );
      ...
      <div className="min-h-screen">
        <div className="relative h-[300px]">
          ...
          <div className="relative container mx-auto px-4 h-full flex items-center justify-center">
            <h1 className="text-white text-5xl font-bold">ARTS & THEATRE</h1>
          </div>
        </div>
